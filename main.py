...
s1 = Student("John Smith", "john@example.com", "123-456-7890", 1, Supervisor("Dr. Jane Doe", "jane@example.com", "555-555-5555", 1), "Ph.D.", "2022-01-01", "Artificial Intelligence")
s2 = Student("Alice Brown", "alice@example.com", "987-654-3210", 2, Supervisor("Dr. Bob Smith", "bob@example.com", "555-555-5555", 2), "MPhil", "2022-02-01", "Data Science")
s3 = Student("James Johnson", "james@example.com", "555-555-5555", 3, Supervisor("Dr. Jane Doe", "jane@example.com", "555-555-5555", 1), "Ph.D.", "2022-01-01", "Computer Vision")
